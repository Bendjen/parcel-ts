  ...
  <div className={style.container}>
    ...
    <Row className={style.line}>
      ...
      <Col span={12} className={style.placeholderInput}>
        <input placeholder="Placeholder Text" type="text" required={true} />
        <span>Help Text</span>
      </Col>
    </Row>
    {/* 必填提示 */}
    ...
    <Row className={style.line}>
      ...
      <Col span={12} className={style.readyonlyInput}>
        <input type="text" value="read-only value" readOnly={true} />
        <span />
      </Col>
    </Row>
    {/* 类型 */}
    ...
    <Row className={style.line}>
      ...
      <Col span={12} className={style.checkInput}>
        <input type="checkbox" name="checkbox" id="check-option-1" value="1" hidden={true} />
