...
class About extends React.Component {
                ...
                >
                    ...
                    <section key="MyProject">
                        ...
                        <div className={style.content} style={{ marginTop: 40 }}>
                            <div className={style.projectItem}>
                                <h2>electron-trial（桌面端应用）</h2>
                                <p data-flex='cross:center'>
                                    <span style={{margin:0}}>应用下载：</span>
                                    <img className={style.electron_app_icon} onClick={this.downloadApp} src="img/assets/electron-trial.png" alt="" />
                                </p>
                                <p>Github：<a href="https://github.com/Bendjen/electron-trial" target="_blank">https://github.com/Bendjen/electron-trial</a></p>
                                <p>标签：electron、node、react</p>
                                <p data-flex='main:center cross:center'>
                                    <img src="img/project/electron-trial.gif" alt="" />
                                </p>
                            </div>
                        </div>
                        <div className={style.content} style={{ marginTop: 40 }}>
    ...
    private downloadApp() {
        FileSaver.saveAs("/parcel-ts/electron-trial Setup 1.0.0.exe", "electron-trial Setup 1.0.0.exe");
    }
}
